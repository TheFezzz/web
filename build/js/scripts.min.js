function burgerMenu() {
    const burger = document.querySelector(".burger"),
        ...
        closeButton = document.querySelector(".menu-close"); // Добавляем кнопку закрытия
...
function fixedNav() {
    ...
    function d(e, t) {
        ...
        } else if (e.nodeType || e === s || e === a) o.push(e);
                ...
                for (let e = 0; e < this.length; e += 1) {
                    ...
                    if (!s && n.dom7Listeners ? r = n.dom7Listeners[t] : s && n.dom7LiveListeners && (r = n.dom7LiveListeners[t]), r && r.length)
                        for (let e = r.length - 1; e >= 0; e -= 1) {
                            const s = r[e];
                            i && s.listener === i || i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i ? (n.removeEventListener(t, s.proxyListener, a), r.splice(e, 1)) : i || (n.removeEventListener(t, s.proxyListener, a), r.splice(e, 1))
                        }
                }
            }
            return this
    ...
    function h(e, t = "x") {
        ...
        return s.WebKitCSSMatrix ? (a = o.transform || o.webkitTransform, a.split(",").length > 6 && (a = a.split(", ").map((e => e.replace(",", "."))).join(", ")), r = new s.WebKitCSSMatrix("none" === a ? "" : a)) : (r = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), i = r.toString().split(",")), "x" === t && (a = s.WebKitCSSMatrix ? r.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === t && (a = s.WebKitCSSMatrix ? r.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), a || 0
    }
        ...
        for (let a = 1; a < e.length; a += 1) {
            ...
            if (null != n && (i = n, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    ...
                    void 0 !== a && a.enumerable && (f(t[i]) && f(n[i]) ? n[i].__swiper__ ? t[i] = n[i] : m(t[i], n[i]) : !f(t[i]) && f(n[i]) ? (t[i] = {}, n[i].__swiper__ ? t[i] = n[i] : m(t[i], n[i])) : t[i] = n[i])
                }
            }
        }
        var i;
    ...
    function S(e = {}) {
        return y || (y = function({
            ...
            const p = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                h = "Win32" === i;
            let f = "MacIntel" === i;
            return !c && f && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (c = a.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), f = !1), d && !h && (r.os = "android", r.android = !0), (c || u || p) && (r.os = "ios", r.ios = !0), r
        }(e)), y
    }
    ...
    function E(e) {
        ...
        if (o.noSwiping && (m ? function(e, t = this) {
                return function t(s) {
                    return s && s !== i() && s !== n() ? (s.assignedSlot && (s = s.assignedSlot), s.closest(e) || t(s.getRootNode().host)) : null
                }(t)
        ...
        if (Object.assign(r, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), l.startX = g, l.startY = v, r.touchStartTime = u(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== p.type) {
            let e = !0;
    ...
    function k(e) {
        ...
        if (a.isTouchEvent && t.activeElement && c.target === t.activeElement && d(c.target).is(a.focusableElements)) return a.isMoved = !0, void(s.allowClick = !1);
        ...
        if (void 0 === a.isScrolling) {
            let e;
            s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? a.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI, a.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
        }
        if (a.isScrolling && s.emit("touchMoveOpposite", c), void 0 === a.startMoving && (r.currentX === r.startX && r.currentY === r.startY || (a.startMoving = !0)), a.isScrolling) return void(a.isTouched = !1);
        if (!a.startMoving) return;
        s.allowClick = !1, !n.cssMode && c.cancelable && c.preventDefault(), n.touchMoveStopPropagation && !n.nested && c.stopPropagation(), a.isMoved || (n.loop && !n.cssMode && s.loopFix(), a.startTranslate = s.getTranslate(), s.setTransition(0), s.animating && s.$wrapperEl.trigger("webkitTransitionEnd transitionend"), a.allowMomentumBounce = !1, !n.grabCursor || !0 !== s.allowSlideNext && !0 !== s.allowSlidePrev || s.setGrabCursor(!0), s.emit("sliderFirstMove", c)), s.emit("sliderMove", c), a.isMoved = !0;
        let v = s.isHorizontal() ? m : g;
        r.diff = v, v *= n.touchRatio, o && (v = -v), s.swipeDirection = v > 0 ? "prev" : "next", a.currentTranslate = v + a.startTranslate;
        let w = !0,
            y = n.resistanceRatio;
    ...
    const I = (e, t) => {
            ...
            (a.preventClicks || a.preventClicksPropagation) && r[p]("click", e.onClick, !0), a.cssMode && o[p]("scroll", e.onScroll), a.updateOnWindowResize ? e[u](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", P, !0) : e[u]("observerUpdate", P, !0)
        },
    ...
    const _ = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    const $ = i.grid && i.grid.rows > 1 && e.grid;
                    let C;
                    $ && e.grid.initSlides(p);
                    ...
                    for (let a = 0; a < p; a += 1) {
                        C = 0;
                        const r = c.eq(a);
                        if ($ && e.grid.updateSlide(a, r, p, t), "none" !== r.css("display")) {
                            if ("auto" === i.slidesPerView) {
                                E && (c[a].style[t("width")] = "");
                                const n = getComputedStyle(r[0]),
                                    o = r[0].style.transform,
                                    l = r[0].style.webkitTransform;
                                if (o && (r[0].style.transform = "none"), l && (r[0].style.webkitTransform = "none"), i.roundLengths) C = e.isHorizontal() ? r.outerWidth(!0) : r.outerHeight(!0);
                                else {
                                    const e = s(n, "width"),
                                        t = s(n, "padding-left"),
                                        i = s(n, "padding-right"),
                            ...
                            } else C = (n - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (C = Math.floor(C)), c[a] && (c[a].style[t("width")] = `${C}px`);
                            c[a] && (c[a].swiperSlideSize = C), f.push(C), i.centeredSlides ? (T = T + C / 2 + S / 2 + b, 0 === S && 0 !== a && (T = T - n / 2 - b), 0 === a && (T = T - n / 2 - b), Math.abs(T) < .001 && (T = 0), i.roundLengths && (T = Math.floor(T)), x % i.slidesPerGroup == 0 && u.push(T), h.push(T)) : (i.roundLengths && (T = Math.floor(T)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && u.push(T), h.push(T), T = T + C + b), e.virtualSize += C + b, S = C, x += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, n) + v, r && o && ("slide" === i.effect || "coverflow" === i.effect) && a.css({
                            width: `${e.virtualSize+i.spaceBetween}px`
                        }), i.setWrapperSize && a.css({
                            [t("width")]: `${e.virtualSize+i.spaceBetween}px`
                        }), $ && e.grid.updateWrapperSize(C, u, t), !i.centeredSlides) {
                        const t = [];
                    ...
                    p !== d && e.emit("slidesLengthChange"), u.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== y && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset()
                },
                ...
                updateSlidesProgress: function(e = this && this.translate || 0) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        const d = (r + (s.centeredSlides ? t.minTranslate() : 0) - l) / (o.swiperSlideSize + s.spaceBetween),
                            c = (r - n[0] + (s.centeredSlides ? t.minTranslate() : 0) - l) / (o.swiperSlideSize + s.spaceBetween),
                            p = -(r - l),
                            u = p + t.slidesSizesGrid[e];
                        (p >= 0 && p < t.size - 1 || u > 1 && u <= t.size || p <= 0 && u >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), i.eq(e).addClass(s.slideVisibleClass)), o.progress = a ? -d : d, o.originalProgress = a ? -c : c
                    }
                ...
                updateProgress: function(e) {
                    ...
                    const o = n,
                        l = r;
                    0 === i ? (a = 0, n = !0, r = !0) : (a = (e - t.minTranslate()) / i, n = a <= 0, r = a >= 1), Object.assign(t, {
                        progress: a,
                        isBeginning: n,
                        isEnd: r
                    }), (s.watchSlidesProgress || s.centeredSlides && s.autoHeight) && t.updateSlidesProgress(e), n && !o && t.emit("reachBeginning toEdge"), r && !l && t.emit("reachEnd toEdge"), (o && !n || l && !r) && t.emit("fromEdge"), t.emit("progress", a)
                },
                ...
                updateClickedSlide: function(e) {
                    ...
                    t.clickedSlide = i, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(d(i).attr("data-swiper-slide-index"), 10) : t.clickedIndex = a, s.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
                }
            },
            translate: {
                ...
                setTranslate: function(e, t) {
                    ...
                    let l, d = 0,
                        c = 0;
                    s.isHorizontal() ? d = i ? -e : e : c = e, a.roundLengths && (d = Math.floor(d), c = Math.floor(c)), a.cssMode ? r[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -d : -c : a.virtualTranslate || n.transform(`translate3d(${d}px, ${c}px, 0px)`), s.previousTranslate = s.translate, s.translate = s.isHorizontal() ? d : c;
            ...
            slide: {
                slideTo: function(e = 0, t = this.params.speed, s = !0, i, a) {
                    ...
                    if (n.initialized && r !== p) {
                        ...
                        if (!n.allowSlidePrev && w > n.translate && w > n.maxTranslate() && (p || 0) !== r) return !1
                    }
                    let y;
                    if (y = r > p ? "next" : r < p ? "prev" : "reset", u && -w === n.translate || !u && w === n.translate) return n.updateActiveIndex(r), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(w), "reset" !== y && (n.transitionStart(s, y), n.transitionEnd(s, y)), !1;
                    if (o.cssMode) {
                        const e = n.isHorizontal(),
                            s = u ? w : -w;
                        if (0 === t) {
                    ...
                    return 0 === t ? (n.setTransition(0), n.setTranslate(w), n.updateActiveIndex(r), n.updateSlidesClasses(), n.emit("beforeTransitionStart", t, i), n.transitionStart(s, y), n.transitionEnd(s, y)) : (n.setTransition(t), n.setTranslate(w), n.updateActiveIndex(r), n.updateSlidesClasses(), n.emit("beforeTransitionStart", t, i), n.transitionStart(s, y), n.animating || (n.animating = !0, n.onSlideToWrapperTransitionEnd || (n.onSlideToWrapperTransitionEnd = function(e) {
                        n && !n.destroyed && e.target === this && (n.$wrapperEl[0].removeEventListener("transitionend", n.onSlideToWrapperTransitionEnd), n.$wrapperEl[0].removeEventListener("webkitTransitionEnd", n.onSlideToWrapperTransitionEnd), n.onSlideToWrapperTransitionEnd = null, delete n.onSlideToWrapperTransitionEnd, n.transitionEnd(s, y))
                ...
                slidePrev: function(e = this.params.speed, t = !0, s) {
                    ...
                    let f = 0;
                    return void 0 !== h && (f = o.indexOf(h), f < 0 && (f = i.activeIndex - 1), "auto" === a.slidesPerView && 1 === a.slidesPerGroup && a.slidesPerGroupAuto && (f = f - i.slidesPerViewDynamic("previous", !0) + 1, f = Math.max(f, 0))), i.slideTo(f, e, t, s)
                },
                ...
                slideToClickedSlide: function() {
                    ...
                    if (t.loop) {
                        ...
                        a = parseInt(d(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), n = s.children(`.${t.slideClass}[data-swiper-slide-index="${a}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), p((() => {
                            e.slideTo(n)
                        }))) : e.slideTo(n) : n > e.slides.length - i ? (e.loopFix(), n = s.children(`.${t.slideClass}[data-swiper-slide-index="${a}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), p((() => {
                            e.slideTo(n)
                        }))) : e.slideTo(n)
                    } else e.slideTo(n)
                }
            ...
            loop: {
                loopCreate: function() {
                    ...
                    for (let e = 0; e < l.length; e += 1) n.append(d(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
                    for (let e = o.length - 1; e >= 0; e -= 1) n.prepend(d(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass))
                },
                loopFix: function() {
                    const e = this;
                    ...
                    t < i ? (l = s.length - 3 * i + t, l += i, e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((o ? -e.translate : e.translate) - d)) : t >= s.length - i && (l = -s.length + t + i, l += i, e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((o ? -e.translate : e.translate) - d)), e.allowSlidePrev = a, e.allowSlideNext = n, e.emit("loopFix")
                },
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = E.bind(e), e.onTouchMove = k.bind(e), e.onTouchEnd = M.bind(e), s.cssMode && (e.onScroll = L.bind(e)), e.onClick = z.bind(e), a.touch && !O && (t.addEventListener("touchstart", A), O = !0), I(e, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    const l = (o in r ? r[o] : void 0) || e.originalParams,
                        ...
                        c = D(e, l),
                        p = a.enabled;
                    d && !c ? (n.removeClass(`${a.containerModifierClass}grid ${a.containerModifierClass}grid-column`), e.emitContainerClasses()) : !d && c && (n.addClass(`${a.containerModifierClass}grid`), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === a.grid.fill) && n.addClass(`${a.containerModifierClass}grid-column`), e.emitContainerClasses());
            ...
            images: {
                loadImage: function(e, t, s, i, a, r) {
                    ...
                    d(e).parent("picture")[0] || e.complete && a ? c() : t ? (l = new o.Image, l.onload = c, l.onerror = c, i && (l.sizes = i), s && (l.srcset = s), t && (l.src = t)) : c()
                },
    ...
    class B {
        constructor(...e) {
            ...
            }), i.browser = x(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
            const a = {};
            i.modules.forEach((e => {
                e({
                    swiper: i,
            ...
            const n = m({}, H, a);
            return i.params = m({}, n, j, s), i.originalParams = m({}, i.params), i.passedParams = m({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
    ...
    function W(e, t, s, a) {
        ...
        return e.params.createElements && Object.keys(a).forEach((i => {
            if (!s[i] && !0 === s.auto) {
                ...
                r || (r = n.createElement("div"), r.className = a[i], e.$el.append(r)), s[i] = r, t[i] = r
            }
        })), s
    }
    ...
    function Y(e, t) {
        ...
        a.loop && s.loopCreate(), a.observer || s.update(), a.loop ? s.slideTo(l + s.loopedSlides, 0, !1) : s.slideTo(l, 0, !1)
    }
    ...
    function K({
        ...
        if (e.params.virtualTranslate && 0 !== t) {
            let t, o = !1;
            t = i ? s ? a.find(s) : a : s ? a.eq(n).find(s) : a.eq(n), t.transitionEnd((() => {
                if (o) return;
                if (!e || e.destroyed) return;
                o = !0, e.animating = !1;
    ...
    function Z(e, t, s) {
        ...
        let n = a.children(`.${i}`);
        return n.length || (n = d(`<div class="swiper-slide-shadow${s?`-${s}`:""}"></div>`), a.append(n)), n
    }
    Object.keys(_).forEach((e => {
        ...
        t("init", (() => {
            ...
            a && a.unobserve && e.el && (a.unobserve(e.el), a = null), i.removeEventListener("resize", r), i.removeEventListener("orientationchange", o)
        }))
    }, function({
        swiper: e,
        extendParams: t,
    ...
    const Q = [function({
        ...
        function a(t, s) {
            ...
            const a = i.renderSlide ? d(i.renderSlide.call(e, t, s)) : d(`<div class="${e.params.slideClass}" data-swiper-slide-index="${s}">${t}</div>`);
            return a.attr("data-swiper-slide-index") || a.attr("data-swiper-slide-index", s), i.cache && (e.virtual.cache[s] = a), a
        }
        ...
        function n(t) {
            ...
            let f, m, g;
            f = e.rtlTranslate ? "right" : e.isHorizontal() ? "left" : "top", n ? (m = Math.floor(s / 2) + i + o, g = Math.floor(s / 2) + i + r) : (m = s + (i - 1) + o, g = i + r);
            const v = Math.max((h || 0) - g, 0),
                w = Math.min((h || 0) + m, c.length - 1),
            ...
            if (Object.assign(e.virtual, {
                ...
                }), l === v && d === w && !t) return e.slidesGrid !== p && y !== u && e.slides.css(f, `${y}px`), void e.updateProgress();
            ...
            if (t) e.$wrapperEl.find(`.${e.params.slideClass}`).remove();
                ...
                for (let t = l; t <= d; t += 1)(t < v || t > w) && e.$wrapperEl.find(`.${e.params.slideClass}[data-swiper-slide-index="${t}"]`).remove();
            for (let e = 0; e < c.length; e += 1) e >= v && e <= w && (void 0 === d || t ? S.push(e) : (e > d && S.push(e), e < l && T.push(e)));
            S.forEach((t => {
                e.$wrapperEl.append(a(c[t], t))
            })), T.sort(((e, t) => t - e)).forEach((t => {
                e.$wrapperEl.prepend(a(c[t], t))
            })), e.$wrapperEl.children(".swiper-slide").css(f, `${y}px`), b()
        }
        t({
            virtual: {
                enabled: !1,
            ...
            prependSlide: function(t) {
                ...
                if (e.params.virtual.cache) {
                    ...
                    Object.keys(t).forEach((e => {
                        ...
                        n && i.attr("data-swiper-slide-index", parseInt(n, 10) + a), s[parseInt(e, 10) + a] = i
                    })), e.virtual.cache = s
                }
                n(!0), e.slideTo(i, 0)
            },
        ...
        function l(t) {
            ...
            if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || r.activeElement && r.activeElement.nodeName && ("input" === r.activeElement.nodeName.toLowerCase() || "textarea" === r.activeElement.nodeName.toLowerCase()))) {
                ...
                e.isHorizontal() ? ((d || c || p || u) && (i.preventDefault ? i.preventDefault() : i.returnValue = !1), ((c || u) && !s || (d || p) && s) && e.slideNext(), ((d || p) && !s || (c || u) && s) && e.slidePrev()) : ((d || c || h || f) && (i.preventDefault ? i.preventDefault() : i.returnValue = !1), (c || f) && e.slideNext(), (d || h) && e.slidePrev()), a("keyPress", n)
            }
        }
        ...
        function m(t) {
            return !(e.params.mousewheel.thresholdDelta && t.delta < e.params.mousewheel.thresholdDelta || e.params.mousewheel.thresholdTime && u() - l < e.params.mousewheel.thresholdTime || !(t.delta >= 6 && u() - l < 60) && (t.direction < 0 ? e.isEnd && !e.params.loop || e.animating || (e.slideNext(), i("scroll", t.raw)) : e.isBeginning && !e.params.loop || e.animating || (e.slidePrev(), i("scroll", t.raw)), l = (new a.Date).getTime(), 1))
        }
        ...
        function g(t) {
            ...
            let l = e.$el;
            if ("container" !== e.params.mousewheel.eventsTarget && (l = d(e.params.mousewheel.eventsTarget)), !e.mouseEntered && !l[0].contains(s.target) && !n.releaseOnEdges) return !0;
            ...
            if (v >= e.minTranslate() && (v = e.minTranslate()), v <= e.maxTranslate() && (v = e.maxTranslate()), a = !!e.params.loop || !(v === e.minTranslate() || v === e.maxTranslate()), a && e.params.nested && s.stopPropagation(), e.params.freeMode && e.params.freeMode.enabled) {
                const t = {
                        time: u(),
                        delta: Math.abs(h),
                        direction: Math.sign(h)
                    },
                    a = o && t.time < o.time + 500 && t.delta <= o.delta && t.direction === o.direction;
                if (!a) {
                    ...
                    if (a || i("scroll", s), e.params.autoplay && e.params.autoplayDisableOnInteraction && e.autoplay.stop(), l === e.minTranslate() || l === e.maxTranslate()) return !0
                }
            } else {
                const s = {
                    time: u(),
                ...
                if (c.push(s), i ? (s.direction !== i.direction || s.delta > i.delta || s.time > i.time + 150) && m(s) : m(s), function(t) {
        ...
        function v(t) {
            let s = e.$el;
            "container" !== e.params.mousewheel.eventsTarget && (s = d(e.params.mousewheel.eventsTarget)), s[t]("mouseenter", h), s[t]("mouseleave", f), s[t]("wheel", g)
        }
        ...
        t({
            ...
            if (e.params.navigation.hideOnClick && !d(r).is(n) && !d(r).is(a)) {
                ...
                let t;
                a ? t = a.hasClass(e.params.navigation.hiddenClass) : n && (t = n.hasClass(e.params.navigation.hiddenClass)), i(!0 === t ? "navigationShow" : "navigationHide"), a && a.toggleClass(e.params.navigation.hiddenClass), n && n.toggleClass(e.params.navigation.hiddenClass)
            }
        ...
        function c() {
            ...
            if (e.params.loop ? (p = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), p > a - 1 - 2 * e.loopedSlides && (p -= a - 2 * e.loopedSlides), p > u - 1 && (p -= u), p < 0 && "bullets" !== e.params.paginationType && (p = u + p)) : p = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                const i = e.pagination.bullets;
                let a, o, u;
                if (s.dynamicBullets && (n = i.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", n * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (r += p - e.previousIndex, r > s.dynamicMainBullets - 1 ? r = s.dynamicMainBullets - 1 : r < 0 && (r = 0)), a = p - r, o = a + (Math.min(i.length, s.dynamicMainBullets) - 1), u = (o + a) / 2), i.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), c.length > 1) i.each((e => {
                    const t = d(e),
                        i = t.index();
                    i === p && t.addClass(s.bulletActiveClass), s.dynamicBullets && (i >= a && i <= o && t.addClass(`${s.bulletActiveClass}-main`), i === a && l(t, "prev"), i === o && l(t, "next"))
                }));
                else {
                    const t = i.eq(p),
                        n = t.index();
                    if (t.addClass(s.bulletActiveClass), s.dynamicBullets) {
                        const t = i.eq(a),
                            r = i.eq(o);
                        for (let e = a; e <= o; e += 1) i.eq(e).addClass(`${s.bulletActiveClass}-main`);
                        if (e.params.loop)
            ...
            if ("fraction" === s.type && (c.find(q(s.currentClass)).text(s.formatFractionCurrent(p + 1)), c.find(q(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
                let t;
                t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                const i = (p + 1) / u;
                let a = 1,
                    n = 1;
                "horizontal" === t ? a = i : n = i, c.find(q(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${a}) scaleY(${n})`).transition(e.params.speed)
            }
        ...
        function p() {
            ...
            if ("bullets" === t.type) {
                ...
                a.html(n), e.pagination.bullets = a.find(q(t.bulletClass))
            }
            "fraction" === t.type && (n = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`, a.html(n)), "progressbar" === t.type && (n = t.renderProgressbar ? t.renderProgressbar.call(e, t.progressbarFillClass) : `<span class="${t.progressbarFillClass}"></span>`, a.html(n)), "custom" !== t.type && i("paginationRender", e.pagination.$el[0])
        }
        ...
        s("init", (() => {
            ...
            if (e.params.pagination.el && e.params.pagination.hideOnClick && n.length > 0 && !d(a).hasClass(e.params.pagination.bulletClass)) {
        ...
        function m() {
            ...
            let d = o,
                c = (l - o) * i;
            s ? (c = -c, c > 0 ? (d = o - c, c = 0) : -c + o > l && (d = l + c)) : c < 0 ? (d = o + c, c = 0) : c + o > l && (d = l - c), e.isHorizontal() ? (a.transform(`translate3d(${c}px, 0, 0)`), a[0].style.width = `${d}px`) : (a.transform(`translate3d(0px, ${c}px, 0)`), a[0].style.height = `${d}px`), r.hide && (clearTimeout(h), n[0].style.opacity = 1, h = setTimeout((() => {
        ...
        function g() {
            ...
            s[0].style.width = "", s[0].style.height = "", l = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight, c = e.size / (e.virtualSize + e.params.slidesOffsetBefore - (e.params.centeredSlides ? e.snapGrid[0] : 0)), o = "auto" === e.params.scrollbar.dragSize ? l * c : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? s[0].style.width = `${o}px` : s[0].style.height = `${o}px`, i[0].style.display = c >= 1 ? "none" : "", e.params.scrollbar.hide && (i[0].style.opacity = 0), e.params.watchOverflow && e.enabled && t.$el[e.isLocked ? "addClass" : "removeClass"](e.params.scrollbar.lockClass)
        }
        ...
        function w(t) {
            ...
            let n;
            n = (v(t) - a.offset()[e.isHorizontal() ? "left" : "top"] - (null !== r ? r : o / 2)) / (l - o), n = Math.max(Math.min(n, 1), 0), i && (n = 1 - n);
        ...
        function y(t) {
            ...
            u = !0, r = t.target === l[0] || t.target === l ? v(t) - t.target.getBoundingClientRect()[e.isHorizontal() ? "left" : "top"] : null, t.preventDefault(), t.stopPropagation(), n.transition(100), l.transition(100), w(t), clearTimeout(f), o.transition(0), s.hide && o.css("opacity", 1), e.params.cssMode && e.$wrapperEl.css("scroll-snap-type", "none"), a("scrollbarDragStart", t)
        }
        ...
        function b(t) {
            ...
            u && (t.preventDefault ? t.preventDefault() : t.returnValue = !1, w(t), i.transition(0), n.transition(0), r.transition(0), a("scrollbarDragMove", t))
        }
        ...
        function T(t) {
            ...
            u && (u = !1, e.params.cssMode && (e.$wrapperEl.css("scroll-snap-type", ""), n.transition("")), s.hide && (clearTimeout(f), f = p((() => {
        ...
        function S(t) {
            const {
                ...
                params: r,
                support: o
            } = e, l = s.$el[0], d = !(!o.passiveListener || !r.passiveListeners) && {
                passive: !1,
                capture: !1
            ...
            o.touch ? (l[p](i.start, y, d), l[p](i.move, b, d), l[p](i.end, T, c)) : (l[p](a.start, y, d), n[p](a.move, b, d), n[p](a.end, T, c))
        }
        ...
        function x() {
            ...
            0 === n.length && (n = d(`<div class="${e.params.scrollbar.dragClass}"></div>`), a.append(n)), Object.assign(t, {
                $el: a,
                el: a[0],
                $dragEl: n,
                dragEl: n[0]
            }), i.draggable && e.params.scrollbar.el && S("on"), a && a[e.enabled ? "removeClass" : "addClass"](e.params.scrollbar.lockClass)
        }
        ...
        const i = (t, s) => {
                const {
                    rtl: i
                } = e, a = d(t), n = i ? -1 : 1, r = a.attr("data-swiper-parallax") || "0";
                let o = a.attr("data-swiper-parallax-x"),
                    l = a.attr("data-swiper-parallax-y");
                const c = a.attr("data-swiper-parallax-scale"),
                    p = a.attr("data-swiper-parallax-opacity");
                if (o || l ? (o = o || "0", l = l || "0") : e.isHorizontal() ? (o = r, l = "0") : (l = r, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * s * n + "%" : o * s * n + "px", l = l.indexOf("%") >= 0 ? parseInt(l, 10) * s + "%" : l * s + "px", null != p) {
            ...
            a = () => {
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((e => {
                    ...
                    let r = t.progress;
                    e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (r += Math.ceil(s / 2) - a * (n.length - 1)), r = Math.min(Math.max(r, -1), 1), d(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((e => {
                        i(e, r)
                    }))
                }))
            };
        ...
        function y(t) {
            ...
            u.$imageEl && 0 !== u.$imageEl.length ? (s.gestures ? a.scale = t.scale * c : a.scale = u.scaleMove / u.scaleStart * c, a.scale > u.maxRatio && (a.scale = u.maxRatio - 1 + (a.scale - u.maxRatio + 1) ** .5), a.scale < i.minRatio && (a.scale = i.minRatio + 1 - (i.minRatio - a.scale + 1) ** .5), u.$imageEl.transform(`translate3d(0,0,0) scale(${a.scale})`)) : "gesturechange" === t.type && w(t)
        }
        ...
        function b(t) {
            ...
            u.$imageEl && 0 !== u.$imageEl.length && (n.scale = Math.max(Math.min(n.scale, u.maxRatio), a.minRatio), u.$imageEl.transition(e.params.speed).transform(`translate3d(0,0,0) scale(${n.scale})`), c = n.scale, p = !1, 1 === n.scale && (u.$slideEl = void 0))
        }
        ...
        function T(t) {
            ...
            if (!(i < u.slideWidth && a < u.slideHeight)) {
                if (f.minX = Math.min(u.slideWidth / 2 - i / 2, 0), f.maxX = -f.minX, f.minY = Math.min(u.slideHeight / 2 - a / 2, 0), f.maxY = -f.minY, f.touchesCurrent.x = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, f.touchesCurrent.y = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, !f.isMoved && !p) {
        ...
        function x(t) {
            ...
            let n, r, o, l, p, h, m, g, v, w, y, b, T, S, x, $, C, E;
        ...
        function M(t) {
            ...
            e.$wrapperEl[t]("gesturestart", i, w, s), e.$wrapperEl[t]("gesturechange", i, y, s), e.$wrapperEl[t]("gestureend", i, b, s)
        }
        ...
        function L() {
            ...
            const s = e.support,
                ...
                n = k();
            s.gestures ? (e.$wrapperEl.on(e.touchEvents.start, P, i), e.$wrapperEl.on(e.touchEvents.end, z, i)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.on(e.touchEvents.start, n, w, i), e.$wrapperEl.on(e.touchEvents.move, n, y, a), e.$wrapperEl.on(e.touchEvents.end, n, b, i), e.touchEvents.cancel && e.$wrapperEl.on(e.touchEvents.cancel, n, b, i)), e.$wrapperEl.on(e.touchEvents.move, `.${e.params.zoom.containerClass}`, T, a)
        }
        ...
        function O() {
            ...
            s.gestures ? (e.$wrapperEl.off(e.touchEvents.start, P, i), e.$wrapperEl.off(e.touchEvents.end, z, i)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.off(e.touchEvents.start, n, w, i), e.$wrapperEl.off(e.touchEvents.move, n, y, a), e.$wrapperEl.off(e.touchEvents.end, n, b, i), e.touchEvents.cancel && e.$wrapperEl.off(e.touchEvents.cancel, n, b, i)), e.$wrapperEl.off(e.touchEvents.move, `.${e.params.zoom.containerClass}`, T, a)
        }
        Object.defineProperty(e.zoom, "scale", {
            ...
            e.zoom.enabled && function(t) {
                const s = e.device;
                u.$imageEl && 0 !== u.$imageEl.length && (f.isTouched || (s.android && t.cancelable && t.preventDefault(), f.isTouched = !0, f.touchesStart.x = "touchstart" === t.type ? t.targetTouches[0].pageX : t.pageX, f.touchesStart.y = "touchstart" === t.type ? t.targetTouches[0].pageY : t.pageY))
            }(s)
        })), s("touchEnd", ((t, s) => {
            e.zoom.enabled && function() {
                ...
                const a = m.x * s,
                    ...
                    r = m.y * i,
                    o = f.currentY + r;
                0 !== m.x && (s = Math.abs((n - f.currentX) / m.x)), 0 !== m.y && (i = Math.abs((o - f.currentY) / m.y));
        ...
        function o(t, s = !0) {
            ...
            !n.hasClass(a.elementClass) || n.hasClass(a.loadedClass) || n.hasClass(a.loadingClass) || r.push(n[0]), 0 !== r.length && r.each((t => {
                const r = d(t);
                ...
                e.loadImage(r[0], c || l, p, u, !1, (() => {
                    if (null != e && e && (!e || e.params) && !e.destroyed) {
                        if (l ? (r.css("background-image", `url("${l}")`), r.removeAttr("data-background")) : (p && (r.attr("srcset", p), r.removeAttr("data-srcset")), u && (r.attr("sizes", u), r.removeAttr("data-sizes")), h.length && h.children("source").each((e => {
                            ...
                            })), c && (r.attr("src", c), r.removeAttr("data-src"))), r.addClass(a.loadedClass).removeClass(a.loadingClass), n.find(`.${a.preloaderClass}`).remove(), e.params.loop && s) {
                            const t = n.attr("data-swiper-slide-index");
                            n.hasClass(e.params.slideDuplicateClass) ? o(e.$wrapperEl.children(`[data-swiper-slide-index="${t}"]:not(.${e.params.slideDuplicateClass})`).index(), !1) : o(e.$wrapperEl.children(`.${e.params.slideDuplicateClass}[data-swiper-slide-index="${t}"]`).index(), !1)
                        }
        ...
        function l() {
            const {
                ...
                slides: i,
                activeIndex: a
            } = e, n = e.virtual && s.virtual.enabled, l = s.lazy;
            ...
            if ("auto" === c && (c = 0), r || (r = !0), e.params.watchSlidesProgress) t.children(`.${s.slideVisibleClass}`).each((e => {
                o(n ? d(e).attr("data-swiper-slide-index") : d(e).index())
            }));
            else if (c > 1)
                for (let e = a; e < a + c; e += 1) p(e) && o(e);
            else o(a);
            if (l.loadPrevNext)
                if (c > 1 || l.loadPrevNextAmount && l.loadPrevNextAmount > 1) {
                    ...
                    for (let e = a + c; e < s; e += 1) p(e) && o(e);
                    for (let e = n; e < a; e += 1) p(e) && o(e)
                } else {
        ...
        function c() {
            ...
            h ? (l(), s.off("scroll", c, m)) : a || (a = !0, s.on("scroll", c, m))
        }
        s("beforeInit", (() => {
        ...
        t({
            ...
            setTranslate: function(t, s) {
                ...
                function l(t) {
                    ...
                    }(t), r = -e.controller.spline.interpolate(-s)), r && "container" !== e.params.controller.by || (n = (t.maxTranslate() - t.minTranslate()) / (e.maxTranslate() - e.minTranslate()), r = (s - e.minTranslate()) * n + t.minTranslate()), e.params.controller.inverse && (r = t.maxTranslate() - r), t.updateProgress(r), t.setTranslate(r, e), t.updateActiveIndex(), t.updateSlidesClasses()
                }
                if (Array.isArray(a))
                    for (let e = 0; e < a.length; e += 1) a[e] !== s && a[e] instanceof o && l(a[e]);
                else a instanceof o && s !== a && l(a)
            },
            setTransition: function(t, s) {
                ...
                function r(s) {
                    s.setTransition(t, e), 0 !== t && (s.transitionStart(), s.params.autoHeight && p((() => {
                        ...
                        a && (s.params.loop && "slide" === e.params.controller.by && s.loopFix(), s.transitionEnd())
                    })))
                }
                if (Array.isArray(a))
        ...
        function f() {
            ...
            s && s.length > 0 && (e.isBeginning ? (p(s), r(s)) : (u(s), n(s))), t && t.length > 0 && (e.isEnd ? (p(t), r(t)) : (u(t), n(t)))
        }
        ...
        s("beforeInit", (() => {
            i = d(`<span class="${e.params.a11y.notificationClass}" aria-live="assertive" aria-atomic="true"></span>`)
        })), s("afterInit", (() => {
            e.params.a11y.enabled && (function() {
                const t = e.params.a11y;
                e.$el.append(i);
                const s = e.$el;
                t.containerRoleDescriptionMessage && l(s, t.containerRoleDescriptionMessage), t.containerMessage && c(s, t.containerMessage);
                const a = e.$wrapperEl,
                    n = a.attr("id") || `swiper-wrapper-${function(e=16){return"x".repeat(e).replace(/x/g,(()=>Math.round(16*Math.random()).toString(16)))}(16)}`,
                    r = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite";
                var p;
                p = n, a.attr("id", p),
                    function(e, t) {
                        e.attr("aria-live", t)
                    }(a, r), t.itemRoleDescriptionMessage && l(d(e.slides), t.itemRoleDescriptionMessage), o(d(e.slides), t.slideRole);
                const u = e.params.loop ? e.slides.filter((t => !t.classList.contains(e.params.slideDuplicateClass))).length : e.slides.length;
                let f, v;
                e.slides.each(((s, i) => {
                    const a = d(s),
                        n = e.params.loop ? parseInt(a.attr("data-swiper-slide-index"), 10) : i;
                    c(a, t.slideLabelMessage.replace(/\{\{index\}\}/, n + 1).replace(/\{\{slidesLength\}\}/, u))
                })), e.navigation && e.navigation.$nextEl && (f = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (v = e.navigation.$prevEl), f && f.length && g(f, n, t.nextSlideMessage), v && v.length && g(v, n, t.prevSlideMessage), m() && e.pagination.$el.on("keydown", q(e.params.pagination.bulletClass), h)
            }(), f())
        })), s("toEdge", (() => {
            ...
            e.params.a11y.enabled && function() {
                ...
                m() && e.pagination.bullets.each((s => {
                    const i = d(s);
                    n(i), e.params.pagination.renderBullet || (o(i, "button"), c(i, t.paginationBulletMessage.replace(/\{\{index\}\}/, i.index() + 1)))
                }))
            }()
        })), s("destroy", (() => {
            e.params.a11y.enabled && function() {
                let t, s;
                i && i.length > 0 && i.remove(), e.navigation && e.navigation.$nextEl && (t = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (s = e.navigation.$prevEl), t && t.off("keydown", h), s && s.off("keydown", h), m() && e.pagination.$el.off("keydown", q(e.params.pagination.bulletClass), h)
            }()
        }))
    }, function({
        swiper: e,
        ...
        const r = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            ...
            c = () => {
                a = o(e.params.url), d(e.params.speed, e.paths.value, !1)
            };
        s("init", (() => {
            e.params.history.enabled && (() => {
                ...
                if (e.params.history) {
                    ...
                    i = !0, a = o(e.params.url), (a.key || a.value) && (d(0, a.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener("popstate", c))
                }
            })()
        })), s("destroy", (() => {
            e.params.history.enabled && (() => {
        ...
        const c = () => {
            ...
            p = () => {
                if (r && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && l.history && l.history.replaceState) l.history.replaceState(null, null, `#${e.slides.eq(e.activeIndex).attr("data-hash")}` || ""), s("hashSet");
                    else {
        ...
        function r() {
            ...
            t.attr("data-swiper-autoplay") && (s = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(n), n = p((() => {
                let t;
        ...
        function l() {
            return !!e.autoplay.running && void 0 !== n && (n && (clearTimeout(n), n = void 0), e.autoplay.running = !1, a("autoplayStop"), !0)
        }
        ...
        e.autoplay = {
            ...
            e.params.autoplay.enabled && (o(), i().addEventListener("visibilitychange", c), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", h), e.$el.on("mouseleave", f)))
            ...
            e.$el.off("mouseenter", h), e.$el.off("mouseleave", f), e.autoplay.running && l(), i().removeEventListener("visibilitychange", c)
        ...
        function o(t) {
            ...
            if (e.realIndex !== s.realIndex || n) {
                ...
                if (s.params.loop) {
                    ...
                    r = void 0 === t ? i : void 0 === i ? t : i - l == l - t ? s.params.slidesPerGroup > 1 ? i : l : i - l < l - t ? i : t, o = e.activeIndex > e.previousIndex ? "next" : "prev"
                } else r = e.realIndex, o = r > e.previousIndex ? "next" : "prev";
                n && (r += "next" === o ? a : -1 * a), s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(r) < 0 && (s.params.centeredSlides ? r = r > l ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1 : r > l && s.params.slidesPerGroup, s.slideTo(r, t ? 0 : void 0))
            }
            let r = 1;
            const o = e.params.thumbs.slideThumbActiveClass;
            if (e.params.slidesPerView > 1 && !e.params.centeredSlides && (r = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (r = 1), r = Math.floor(r), s.slides.removeClass(o), s.params.loop || s.params.virtual && s.params.virtual.enabled)
                for (let t = 0; t < r; t += 1) s.$wrapperEl.children(`[data-swiper-slide-index="${e.realIndex+t}"]`).addClass(o);
            else
                for (let t = 0; t < r; t += 1) s.slides.eq(e.realIndex + t).addClass(o)
        }
        e.thumbs = {
            swiper: null
        }, s("beforeInit", (() => {
                        ...
                        if (a.freeMode.momentum) {
                            if (l.velocities.length > 1) {
                                const t = l.velocities.pop(),
                                    ...
                                    n = t.time - s.time;
                                e.velocity = i / n, e.velocity /= 2, Math.abs(e.velocity) < a.freeMode.minimumVelocity && (e.velocity = 0), (n > 150 || u() - t.time > 300) && (e.velocity = 0)
                            } else e.velocity = 0;
                            ...
                            let m;
                            if (c < e.maxTranslate()) a.freeMode.momentumBounce ? (c + e.maxTranslate() < -f && (c = e.maxTranslate() - f), p = e.maxTranslate(), h = !0, l.allowMomentumBounce = !0) : c = e.maxTranslate(), a.loop && a.centeredSlides && (m = !0);
                            else if (c > e.minTranslate()) a.freeMode.momentumBounce ? (c - e.minTranslate() > f && (c = e.minTranslate() + f), p = e.minTranslate(), h = !0, l.allowMomentumBounce = !0) : c = e.minTranslate(), a.loop && a.centeredSlides && (m = !0);
                            ...
                            if (m && i("transitionEnd", (() => {
                                ...
                                if (t = r ? Math.abs((-c - e.translate) / e.velocity) : Math.abs((c - e.translate) / e.velocity), a.freeMode.sticky) {
                                    const s = Math.abs((r ? -c : c) - e.translate),
                                        i = e.slidesSizesGrid[e.activeIndex];
                                    t = s < i ? a.speed : s < 2 * i ? 1.5 * a.speed : 2.5 * a.speed
                                }
                            } else if (a.freeMode.sticky) return void e.slideToClosest();
                            a.freeMode.momentumBounce && h ? (e.updateProgress(p), e.setTransition(t), e.setTranslate(c), e.transitionStart(!0, e.swipeDirection), e.animating = !0, n.transitionEnd((() => {
                                e && !e.destroyed && l.allowMomentumBounce && (s("momentumBounce"), e.setTransition(a.speed), setTimeout((() => {
                                    e.setTranslate(p), n.transitionEnd((() => {
                                        e && !e.destroyed && e.transitionEnd()
                                    }))
                                }), 0))
                            }))) : e.velocity ? (s("_freeModeNoMomentumRelease"), e.updateProgress(c), e.setTransition(t), e.setTranslate(c), e.transitionStart(!0, e.swipeDirection), e.animating || (e.animating = !0, n.transitionEnd((() => {
                                e && !e.destroyed && e.transitionEnd()
        ...
        t({
            ...
            initSlides: t => {
                ...
                i = s / r, a = Math.floor(t / r), s = Math.floor(t / r) === t / r ? t : Math.ceil(t / r) * r, "auto" !== n && "row" === o && (s = Math.max(s, n * r))
            },
            updateSlide: (t, n, r, o) => {
                const {
                    slidesPerGroup: l,
                ...
                if ("row" === p && l > 1) {
                    const e = Math.floor(t / (l * c)),
                        i = t - c * l * e,
                        a = 0 === e ? l : Math.min(Math.ceil((r - e * c * l) / c), l);
                    f = Math.floor(i / a), h = i - f * a + e * l, u = h + f * s / c, n.css({
                        "-webkit-order": u,
                        order: u
                    })
                } else "column" === p ? (h = Math.floor(t / c), f = t - h * c, (h > a || h === a && f === c - 1) && (f += 1, f >= c && (f = 0, h += 1))) : (f = Math.floor(t / i), h = t - f * i);
            ...
            updateWrapperSize: (t, i, a) => {
                ...
                if (e.virtualSize = (t + n) * s, e.virtualSize = Math.ceil(e.virtualSize / l) - n, e.$wrapperEl.css({
                        [a("width")]: `${e.virtualSize+n}px`
                    }), r) {
                    i.splice(0, i.length);
                    const t = [];
                    for (let s = 0; s < i.length; s += 1) {
                        let a = i[s];
                        o && (a = Math.floor(a)), i[s] < e.virtualSize + i[0] && t.push(a)
                    }
                    i.push(...t)
                }
            }
        ...
        Object.assign(e, {
            appendSlide: X.bind(e),
            prependSlide: G.bind(e),
            addSlide: Y.bind(e),
            ...
            setTranslate: () => {
                ...
                for (let e = 0; e < i.length; e += 1) {
                    ...
                    let h = 0,
                        m = 0,
                        g = 0;
                    s % 4 == 0 ? (h = 4 * -n * o, g = 0) : (s - 1) % 4 == 0 ? (h = 0, g = 4 * -n * o) : (s - 2) % 4 == 0 ? (h = o + 4 * n * o, g = o) : (s - 3) % 4 == 0 && (h = -o, g = 3 * o + 4 * o * n), r && (h = -h), p || (m = h, h = 0);
                    const v = `rotateX(${p?0:-a}deg) rotateY(${p?a:0}deg) translate3d(${h}px, ${m}px, ${g}px)`;
                    if (l <= 1 && l > -1 && (f = 90 * s + 90 * l, r && (f = 90 * -s - 90 * l)), t.transform(v), c.slideShadows) {
                        let e = p ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                            s = p ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
                        0 === e.length && (e = d(`<div class="swiper-slide-shadow-${p?"left":"top"}"></div>`), t.append(e)), 0 === s.length && (s = d(`<div class="swiper-slide-shadow-${p?"right":"bottom"}"></div>`), t.append(s)), e.length && (e[0].style.opacity = Math.max(-l, 0)), s.length && (s[0].style.opacity = Math.max(l, 0))
                    }
                }
                if (s.css({
                ...
                s.transform(`translate3d(0px,0,${m}px) rotateX(${e.isHorizontal()?0:f}deg) rotateY(${e.isHorizontal()?-f:0}deg)`)
            },
            setTransition: t => {
                const {
                    $el: s,
            ...
            setTranslate: () => {
                ...
                for (let a = 0; a < t.length; a += 1) {
                    ...
                    let l = -180 * r,
                        ...
                        p = 0;
                    if (e.isHorizontal() ? s && (l = -l) : (p = c, c = 0, d = -l, l = 0), n[0].style.zIndex = -Math.abs(Math.round(r)) + t.length, i.slideShadows) {
                        ...
                        0 === t.length && (t = Z(i, n, e.isHorizontal() ? "left" : "top")), 0 === s.length && (s = Z(i, n, e.isHorizontal() ? "right" : "bottom")), t.length && (t[0].style.opacity = Math.max(-r, 0)), s.length && (s[0].style.opacity = Math.max(r, 0))
                    }
        ...
        t({
            ...
            setTranslate: () => {
                const {
                    ...
                    slides: i,
                    slidesSizesGrid: a
                } = e, n = e.params.coverflowEffect, r = e.isHorizontal(), o = e.translate, l = r ? t / 2 - o : s / 2 - o, d = r ? n.rotate : -n.rotate, c = n.depth;
                for (let e = 0, t = i.length; e < t; e += 1) {
                    ...
                    let p = r ? d * o : 0,
                        ...
                        h = -c * Math.abs(o),
                        f = n.stretch;
                    "string" == typeof f && -1 !== f.indexOf("%") && (f = parseFloat(n.stretch) / 100 * s);
                    let m = r ? 0 : f * o,
                        g = r ? f * o : 0,
                        v = 1 - (1 - n.scale) * Math.abs(o);
                    Math.abs(g) < .001 && (g = 0), Math.abs(m) < .001 && (m = 0), Math.abs(h) < .001 && (h = 0), Math.abs(p) < .001 && (p = 0), Math.abs(u) < .001 && (u = 0), Math.abs(v) < .001 && (v = 0);
                    const w = `translate3d(${g}px,${m}px,${h}px)  rotateX(${u}deg) rotateY(${p}deg) scale(${v})`;
                    if (U(n, t).transform(w), t[0].style.zIndex = 1 - Math.abs(Math.round(o)), n.slideShadows) {
                        ...
                        0 === e.length && (e = Z(n, t, r ? "left" : "top")), 0 === s.length && (s = Z(n, t, r ? "right" : "bottom")), e.length && (e[0].style.opacity = o > 0 ? o : 0), s.length && (s[0].style.opacity = -o > 0 ? -o : 0)
                    }
                }
            },
            setTransition: t => {
        ...
        V({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < t.length; s += 1) {
                    ...
                    d < 0 ? (m = n.next, f = !0) : d > 0 && (m = n.prev, f = !0), u.forEach(((e, t) => {
                        u[t] = `calc(${e}px + (${i(m.translate[t])} * ${Math.abs(d*r)}))`
                    })), h.forEach(((e, t) => {
                        h[t] = m.rotate[t] * Math.abs(d * r)
                    })), a[0].style.zIndex = -Math.abs(Math.round(l)) + t.length;
                    const g = u.join(", "),
                    ...
                    if (f && m.shadow || !f) {
                        ...
                        if (0 === e.length && m.shadow && (e = Z(n, a)), e.length) {
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < t.length; o += 1) {
                    ...
                    let m = 1,
                        g = -2 * c,
                        v = 8 - .75 * Math.abs(c);
                    const w = (o === s || o === s - 1) && c > 0 && c < 1 && (n || e.params.cssMode) && r < a,
                        y = (o === s || o === s + 1) && c < 0 && c > -1 && (n || e.params.cssMode) && r > a;
                    if (w || y) {
                    ...
                    if (i.slideShadows) {
                        ...
                        0 === e.length && (e = Z(i, l)), e.length && (e[0].style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1))
                    }
                    l[0].style.zIndex = -Math.abs(Math.round(d)) + t.length, U(i, l).transform(b)
                }
            },
            setTransition: t => {
                const {
    ...
    setTimeout((function() {
        $("#container").addClass("loaded"), $("#container").hasClass("loaded") && $("#preloader").delay(1e3).queue((function() {
            $(this).remove()
        }))
    }), 3e3)
...
if (historySlider) {
    const e = new Swiper(historySlider, {
        spaceBetween: 20,
        slidesPerView: 1,
        navigation: {
    ...
    e.on("slideChange", (function() {
        console.log(e.realIndex), t.forEach((e => {
            e.classList.remove("history-nav__btn--active")
        })), document.querySelector(`.history-nav__btn[data-index="${e.realIndex}"]`).classList.add("history-nav__btn--active")
    }));
    const t = document.querySelectorAll(".history-nav__btn");
    t.forEach(((s, i) => {
        s.setAttribute("data-index", i), s.addEventListener("click", (s => {
            const i = s.currentTarget.dataset.index;
            t.forEach((e => {
                e.classList.remove("history-nav__btn--active")
            })), s.currentTarget.classList.add("history-nav__btn--active"), e.slideTo(i)
        }))
    }))
}

function accordion() {
    document.querySelectorAll(".accordion__item-trigger").forEach((e => {
        e.addEventListener("click", (() => {
            const t = e.parentNode;
            t.classList.contains("accordion__item-active") ? t.classList.remove("accordion__item-active") : (document.querySelectorAll(".accordion__item").forEach((e => e.classList.remove("accordion__item-active"))), t.classList.add("accordion__item-active"))
        }))
    }))
}
...
$(document).ready((function() {
...
})), accordion(), window.onclick = function(e) {
    if (!e.target.matches(".dropbtn")) {
        var t, s = document.getElementsByClassName("dropdown-content");
    ...
    $(".content").slice(0, 9).show(), $("#loadMore").on("click", (function(e) {
        e.preventDefault(), $(".content:hidden").slice(0, 4).slideDown(), 0 == $(".content:hidden").length && $("#loadMore").text("No Content").addClass("noContent")
    }))
})), $(document).ready((function() {
    $(".slider-for").slick({
        slidesToShow: 1,
...
const heroSliderSpeed = 1500,
    ...
    fooBar = bodyStyles.getPropertyValue("--hero-slider-speed");
document.body.style.setProperty("--hero-slider-speed", "1500ms");
const swiperWap = new Swiper(".hero-slider", {
        ...
        on: {
            init: function() {
                document.querySelectorAll(".hero__pag .swiper-pagination-bullet").forEach((e => {
...
document.addEventListener('DOMContentLoaded', function() {
    // Обработка hover-эффектов для кнопок
    const buttons = {
        '.btn-primary': {
            default: { background: '#ff5a30' },
            hover: { background: '#fc3300' }
        },
        '.btn-outline': {
            default: { background: 'transparent', border: '1px solid #fff', color: '#fff' },
            hover: { background: '#ff5a30', border: '1px solid #ff5a30', color: '#fff' }
        },
        '.btn--stroke': {
            default: { color: '#fff', background: 'transparent', border: '1px solid #fff' },
            hover: { color: '#424551', background: '#e5e8ed', border: '1px solid #e5e8ed' }
        },
        '.btn--fill': {
            default: { background: '#ff5a30' },
            hover: { background: '#fc3300' }
        },
        '.project__button-outline': {
            default: { background: '#fff', color: '#ff5a30', border: '1px solid #ff5a30' },
            hover: { background: '#ff5a30', color: '#fff' }
        },
        '.jobs__btn': {
            default: { background: 'transparent', color: '#ff5a30', border: '1px solid #ff5a30' },
            hover: { background: '#ff5a30', color: '#fff' }
        },
        '.jobs__sub': {
            default: { background: 'transparent', color: '#ff5a30', border: '1px solid #ff5a30' },
    ...
    // Применяем hover-эффекты через JavaScript
    for (const selector in buttons) {
        const elements = document.querySelectorAll(selector);
        const styles = buttons[selector];
        
        elements.forEach(button => {
            // Применяем стили по умолчанию
            Object.assign(button.style, styles.default);
    ...
    inputFields.forEach(input => {
        ...
        errorMessage.style.color = '#ff5a30';
    ...
    function showError(field, errorElement, message) {
        field.style.borderColor = '#ff5a30';
        errorElement.textContent = message;
        errorElement.style.display = 'block';
    }

    function hideError(field, errorElement) {
        field.style.borderColor = '#d7dadd';
...
document.addEventListener('DOMContentLoaded', function() {
  const goTopButton = document.getElementById('gotop-1');
